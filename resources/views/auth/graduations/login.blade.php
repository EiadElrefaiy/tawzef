			...
			<div class="col-md-6 col-md-offset-3">
				<div class="login-panel panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">دخول ( خريج )</h3>
					</div>
					<div class="panel-body">
						<form action="{{ route('graduation.login') }}" role="form" class="login-form" method="POST">
							...
							<fieldset>
                                ...
                                <br>
                                <p>ليس لديك حساب <a href="{{ route('get-graduation.register') }}" class="cl-success">اضغط هنا </a></p>
							</fieldset>
						</form>
