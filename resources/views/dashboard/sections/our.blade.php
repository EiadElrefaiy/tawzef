                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Our</strong>
                                <strong class="table-db" style="display:none;">our</strong>
                                <strong class="view" style="display:none;">dashboard.sections.our</strong>
                                <button id="addItemBtn" class="btn btn-success text-white pull-right" data-toggle="modal" data-target="#addItemModal">
                                    <i class="fa fa-plus-square"></i> &nbsp; Add Our
                                </button>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <img src="{{ asset($item->image) }}" alt="user" width="250" />
                                                @else
                                                <img src="{{ URL::asset('images/default.jpg') }}" alt="user" width="250">
                                                @endif
                                                </td>
