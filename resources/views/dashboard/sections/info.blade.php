                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <strong class="table-db" style="display:none;">info</strong>
                                <strong class="view" style="display:none;">dashboard.sections.info</strong>

                                <button id="addItemBtn" class="btn btn-success text-white pull-right" data-toggle="modal" data-target="#addItemModal">
                                    <i class="fa fa-plus-square"></i> &nbsp; Add Info
                                </button>
                            </div>
                            <div class="card-body">
