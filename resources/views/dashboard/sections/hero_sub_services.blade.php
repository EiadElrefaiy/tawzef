                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Hero Sub Services</strong>
                                <strong class="table-db" style="display:none;">hero_sub_services</strong>
                                <strong class="view" style="display:none;">dashboard.sections.hero_sub_services</strong>
