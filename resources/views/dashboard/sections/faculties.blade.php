                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <strong class="card-title">Faculties</strong>
                                <strong class="table-db" style="display:none;">faculty</strong>
                                <strong class="view" style="display:none;">dashboard.sections.faculties</strong>
                                <button id="addItemBtn" class="btn btn-success text-white pull-right" data-toggle="modal" data-target="#addItemModal">
                                    <i class="fa fa-plus-square"></i> &nbsp; Add faculty
                                </button>
                            </div>
                            <div class="card-body">
