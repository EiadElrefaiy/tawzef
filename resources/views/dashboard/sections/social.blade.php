                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Social Info</strong>
                                <strong class="table-db" style="display:none;">social</strong>
                                <strong class="view" style="display:none;">dashboard.sections.social</strong>
