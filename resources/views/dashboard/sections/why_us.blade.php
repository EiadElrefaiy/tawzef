                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Why Us</strong>
                                <strong class="table-db" style="display:none;">why_us</strong>
                                <strong class="view" style="display:none;">dashboard.sections.why_us</strong>

                                <button id="addItemBtn" class="btn btn-success text-white pull-right" data-toggle="modal" data-target="#addItemModal">
                                    <i class="fa fa-plus-square"></i> &nbsp; Add Why_Us
                                </button>
                            </div>
                            <div class="card-body">
